                ...
                <div className="bg-white rounded-lg shadow overflow-hidden">
                    <div className="overflow-x-auto">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <div className="text-sm text-gray-500">
                                                    {consultation.patient?.age || 0} years · {consultation.patient?.gender || 'Unknown'}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        {consultation.diagnosis || 'Unknown'}
                      </span>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            <div className="w-full bg-gray-200 rounded-full h-2.5">
                                                <div
                                                    className={`h-2.5 rounded-full ${
                                                        (consultation.probability || 0) > 70
                                                            ? 'bg-red-600'
                                                            : (consultation.probability || 0) > 30
                                                                ? 'bg-yellow-500'
                                                                : 'bg-green-500'
                                                    }`}
                                                    style={{ width: `${consultation.probability || 0}%` }}
                                                ></div>
                                            </div>
                                            <span className="ml-2 text-sm font-medium text-gray-700">
                          {(consultation.probability || 0).toFixed(1)}%
                        </span>
                                        </div>
                                    </td>
